...
route.route("/generate-otp").get(controllers.generateOTP); //generate random otp
...
route.route("/login").post(controllers.login); // login  in app

//put apis

route.route("/update-user").put(controllers.updateUser); //use to update user profile
